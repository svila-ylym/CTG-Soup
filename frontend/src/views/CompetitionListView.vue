  ...
  <main class="page-shell">
    <div class="page-container">
      ...
      <div v-else class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        <article v-for="competition in competitions" :key="competition.id" class="surface-card flex min-h-64 cursor-pointer flex-col p-5 transition hover:border-blue-400" @click="router.push(`/competitions/${competition.id}`)">
